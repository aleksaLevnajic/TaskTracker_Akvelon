...
namespace TaskTracker.DataAccess.Migrations
{
    ...
    [Migration("20231212175047_RevertLazyLoading")]
    partial class RevertLazyLoading
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskTracker.DataAccess.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Priority = 1,
                            StartDate = new DateTime(2023, 12, 12, 17, 50, 46, 481, DateTimeKind.Utc).AddTicks(8200),
                            Status = 2
                        });
                });
